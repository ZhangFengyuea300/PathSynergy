...
#读取数据
result = read_csvs('./data_generation/drug_pathway.csv')     # 药物-通路数据
#result = read_csvs('drug-pathway.csv')
cell_line = read_csvs('./data_generation/cell_line_data.csv')    # 细胞系-基因表达量数据
...
drug_synergy = pd.read_csv('./data_generation/6271_drug_synergy.csv')    # 样本数据
...
np.save('matrix_drug_cell.npy', matrix) 
